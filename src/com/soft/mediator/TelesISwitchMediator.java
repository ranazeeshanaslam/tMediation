 ...
 * @version 1.0
 */
public class TelesISwitchMediator {
         ...
         parms.setLogFilePath(path+"logs/");
          ...
          String sep_string = ",";
			...
			try{
				...
				TelesISwitchMediator ism = new TelesISwitchMediator();
          ...
          try {
              ...
              */
	          ...
	          for(int i=0; i<NoOfThreads; i++){
	        	  TelesiSwitchCDRMediator mediator = new TelesiSwitchCDRMediator();
              ...
              for (int isSecondary=0; isSecondary < 2; isSecondary++){
            	  ...
            	  if (dir == null || destdir == null){
	                  ...
	                  System.out.println("Number of Files Found :"+len);
	                  logger.debug("Number of Files Found :"+len);
	                        	  ...
	                        	  if (sdrfile.getFN_FILEID()> 0) {
	                        	    	...
	                        	    	boolean isAllocated=false;
			              	            ...
			              	            for(int i=0; i<NoOfThreads && !isAllocated ; i++){
			              	            	TelesiSwitchCDRMediator mediator = (TelesiSwitchCDRMediator)ThreadArray.get(i);
			              	            	if (!mediator.isAlive()){
			              	        			mediator = new TelesiSwitchCDRMediator(i+1, Filename, sdrfile, isSecondary,
