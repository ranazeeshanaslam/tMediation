...
public class TelesC5Mediator_1_1 {

    boolean isRunning = false;

    static String VersionInfo ="TelesC5Mediator-1.1";
    static String LastModificationDate = "12-08-2014";
    ...
    public static void main(String argv[]) throws IOException {
    	 ...
    	 System.out.println("Last Update Date :"+LastModificationDate);
		  ...
		  try{
			...
			TelesC5Mediator_1_1 mediator = new TelesC5Mediator_1_1();
