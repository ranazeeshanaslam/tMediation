          ...
          try {
              ...
              if (!dir.isDirectory() || !destdir.isDirectory()) {
                  ...
                  for (int j = 0; j < FileNames.length; j++) {
                      ...
                      if(Filename.contains("pin")) // as pin files have to be processes seperately
                    	  continue;
		                                          ...
		                                          while (i < lineLength) {
		                                           ...
		                                           try{
		                                                  switch (wordscount) {
			                                                  ...
			                                                  case 6: cdrCalledNumber =  value.trim();  break; 	      			//6
			                                                  case 7: dContext =  value.trim();  break; 	      		//7
			                                                  case 8: Disposition =  value.trim();  break;
			                                                      		//8
		                                            ...
		                                            if(dContext == null)
		                                            	dContext = "";
		                                            if(dContext.equalsIgnoreCase("a2billingrs"))
                                        	    		continue;
		                                            ...
		                                            if (CalledNumber != "" && CalledNumber.length() != 0) {
		                                        	    ...
		                                        	    if (duplicate){
		                                        	    	...
		                                        	    	if(CalledNumber.length()>3){
				                                        	    if(!orgCalledNumber.substring(0,3).equalsIgnoreCase("ZAP")){
				                                        	      	CalledNumber="";
				                                        	    	TCalledNumber="";
				                                        	   		AS_CHARGE=0;
				                                        	    }
...
//	                                        	    	logger.debug(sql);
			                            			    	...
			                            			    	" values ( '"+ANI+"',  "+CalldateTime+", "+translatedDuration+", " +
			                            	    	  		" '"+ANI+"', '"+ANI+"', '"+CalledNumber+"', '"+TCalledNumber+"'," +
			                            	    	  		" '', '', '"+inboundTrunk+"', '"+outboundTrunk+"'," +
			                            	    	  		" '"+dContext+"',  '', '', '', '"+orgCalledNumber+"'," +
			                            	    	  		" '', '', '', '', " +
