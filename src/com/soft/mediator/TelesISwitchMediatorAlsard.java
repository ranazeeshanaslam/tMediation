 ...
 * @author Naveed Alyas
 */
public class TelesISwitchMediatorAlsard{
    ...
    public TelesISwitchMediatorAlsard() {
    ...
    public static void main(String argv[]) throws IOException {	
         ...
         parms.setLogFilePath(path+"logs/");
          ...
          String sep_string = ",";
			...
			try{
				...
				TelesISwitchMediatorAlsard ism = new TelesISwitchMediatorAlsard();
				CollectSystemStatistics css = new CollectSystemStatistics(conn, logger);
				css.run();
				long Records = 0;
				if (Util.validateSystem(conn, logger)){
					Records = ism.mediateTelesISwitchCDRsAlsard(conf, dbConnector, sep_string, logger, parms);
				}else{
      ...
      public long mediateTelesISwitchCDRsAlsard(MediatorConf conf, DBConnector dbConnector,
          ...
          try {
              ...
              */
	          ...
	          for(int i=0; i<NoOfThreads; i++){
	        	  TelesiSwitchCDRMediatorAlsard mediator = new TelesiSwitchCDRMediatorAlsard();
	                        	  ...
	                        	  if (sdrfile.getFN_FILEID()> 0) {
	                        	    	...
	                        	    	boolean isAllocated=false;
			              	            ...
			              	            for(int i=0; i<NoOfThreads && !isAllocated ; i++){
			              	            	TelesiSwitchCDRMediatorAlsard mediator = (TelesiSwitchCDRMediatorAlsard)ThreadArray.get(i);
			              	            	if (!mediator.isAlive()){
			              	        		
			              	        			mediator = new TelesiSwitchCDRMediatorAlsard(i+1, Filename, sdrfile, instanceid,
