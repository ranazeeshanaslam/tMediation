 ...
 * @version 1.0
 */
public class TerminusMediator31{
    ...
    static Hashtable elementHash;
    	...
    	*/
        ...
        PropertyConfigurator.configure(path + "conf/log_tmediator31.properties");
        ...
        DBConnector dbConnector;
          ...
          try {
              conf = new MediatorConf(path +"conf/conf_tmediator31.properties");
          } catch (Exception ex1) {
            try {
         ...
         parms.setLogFilePath(path+"logs/");
          ...
          if (seprator == 2) {
			...
			try{
				...
				TerminusMediator31 ism = new TerminusMediator31();
          ...
          try {
             ...
             // stmt = conn.createStatement();
	          ...
	          for(int i=0; i<NoOfThreads; i++){
	        	TerminusCDRMediator31 mediator = new TerminusCDRMediator31();
	                        	  ...
	                        	  if (sdrfile.getFN_FILEID()> 0) {
	                        	    	...
	                        	    	boolean isAllocated=false;
			              	            ...
			              	            for(int i=0; i<NoOfThreads && !isAllocated ; i++){
			              	            	TerminusCDRMediator31 mediator = (TerminusCDRMediator31)ThreadArray.get(i);
			              	            	if (!mediator.isAlive()){
			              	        			mediator = new TerminusCDRMediator31(i+1, Filename, sdrfile, isSecondary,
